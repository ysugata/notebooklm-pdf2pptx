...
4. **適用前に修正計画の一覧(どこを何から何へ)をユーザーに提示**する。
   ...
   ```
   ✓ 確認: 出力の「拒否 0」。拒否>0なら理由を読んで answers を直し再実行
   (拒否を残したまま次へ進まない)。
...
- [ ] 全Nタスクが fix / skip / needs_human のいずれかに分類済み
- [ ] 適用前に修正計画を提示しユーザーの了承を得た
- [ ] feedback_apply の拒否 0
- [ ] report.html 生成済み・needs_human 全件列挙
